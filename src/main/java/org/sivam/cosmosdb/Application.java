...
public class Application {
    ...
    @Autowired
    private DocKeyMetaConfiguration docKeyConfig;
    ...
    @PostConstruct
    public void setup() {
        user = new User(ID, docKeyConfig.encryptEmail(EMAIL), docKeyConfig.encryptName(NAME), address, Arrays.asList(creator, contributor));
